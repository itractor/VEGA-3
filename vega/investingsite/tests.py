...
def create_stock(stockid, stockname, ticker, price, earnings):
    """
...
class StockIndexViewTests(TestCase):
    ...
    def test_price_to_earnings(self):
        ...
        If no questions exist, an appropriate message is displayed.
        """
        stock = create_stock("MOWIXOSL2019", "MOWI", "MOWI", Decimal('12.9'), Decimal('12.9'))
        print(stock.pricetoearnings())
        self.assertEqual(stock.pricetoearnings(), 1)